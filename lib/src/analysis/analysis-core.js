...
(function(window) {
    ...
    const AnalysisCore = {
        ...
        runReview: async function(gameData) {
            ...
            // We await a Promise that resolves after a zero-delay setTimeout. This pushes the
            // board creation to the next event cycle, giving the browser time to render
            // the #analysis-visualizer element before we try to use it.
            await new Promise(resolve => setTimeout(() => {
                ...
                resolve(); // The promise resolves after the board is created.
            }, 0));
