...
// ===================================================================================
//  UI-HTML.JS
//  Contains all HTML templates as JavaScript template literals. This removes the
//  need for external file loading and bypasses browser security restrictions.
// ===================================================================================
    ...
    <div id="log-box-header" class="bg-inset p-2 rounded-t-lg cursor-move flex justify-between items-center">
        ...
        <div id="log-box-controls" class="flex items-center gap-x-2 w-full">
            ...
            <div class="relative">
                ...
                <div id="log-filter-menu" class="hidden absolute left-0 mt-2 w-48 bg-bg-inset-deep rounded-md shadow-lg z-10 p-2 border themed-border">
                    <h4 class="text-sm font-bold mb-1 px-2 text-light">Visible Log Types</h4>
                    <div id="log-filter-options" class="space-y-1 text-light text-sm"></div>
                </div>
            </div>
