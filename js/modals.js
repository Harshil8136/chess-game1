// ===================================================================================
//  MODALS.JS
//  Defines all pop-up modals used throughout the application.
// ===================================================================================

/**
 * Displays the piece promotion selection dialog.
 * @param {string} color - The color of the pawn to promote ('w' or 'b').
 * @param {string} pieceTheme - The key for the currently selected piece theme.
 */
function showPromotionDialog(color, pieceTheme) {
    console.log({ logType: 'info', text: 'Opening promotion dialog.' });
    const pieceThemePath = PIECE_THEMES[pieceTheme];
...
/**
 * Displays the keyboard shortcuts information modal.
 */
...
/**
 * Displays the time control selection modal for a new game.
 */
    ...
    Swal.fire({
        ...
        didOpen: () => {
            $('.time-control-btn').on('click', function() {
                ...
                $('#time-control-selector').val(key).trigger('change');
