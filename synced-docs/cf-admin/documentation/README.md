...
| [`program/chunks/2026-09-10-08b-hot-query-correctness.md`](program/chunks/2026-09-10-08b-hot-query-correctness.md) | Chunk 8b record: the four queries whose cost grows with table size rather than traffic — a 565:1 leading-wildcard `LIKE` replaced by a stored setting, an aggregate moved onto an indexed bucket column, a 319:1 `COUNT(*)` indexed, and an N+1 collapsed to one statement; carries an additive migration | ai, technical, owner | draft |
