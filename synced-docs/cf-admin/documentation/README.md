...
| [`program/chunks/2026-09-02-02-config-truth.md`](program/chunks/2026-09-02-02-config-truth.md) | Chunk 2 record: `Env` generated from `wrangler.toml`, required-secrets validation at deploy, the 92 untyped env accesses fixed at source, `.dev.vars.example`, offline build flag, and C-12 (`_headers`) closed by evidence | ai, technical, owner, operator | active |
