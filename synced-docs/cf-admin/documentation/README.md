...
| [`features/CFZT-GOOGLE-QUICK-RESUME.md`](features/CFZT-GOOGLE-QUICK-RESUME.md) | Cloudflare Zero Trust Edge Authentication: single-sign architecture, Google OAuth + OTP, pipeline verification, account switching, and error handling runbook | ai, technical, operator | active |
