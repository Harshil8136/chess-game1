...
| [`commercial/analyses/2026-07-26-commercial-model-costing-pricing-and-scale.md`](commercial/analyses/2026-07-26-commercial-model-costing-pricing-and-scale.md) | Commercial model: per-deployment fleet costing, unit economics, pricing floor/recommended/ceiling, scale ceilings, ICP, modularity fact-check | owner, technical, operator, ai | active |
