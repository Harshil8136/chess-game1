...
> **TL;DR (non-technical):** How staff edit the public website's content (hero, gallery, reviews, services) from the admin portal, and how those edits appear on the live site within seconds.
...
- **ISR_CACHE KV binding** → See [OPERATIONS.md](../operations/OPERATIONS.md) §1 (KV Namespaces table)
- **KV quota limits, exhaustion behaviour & fallback chain** → See [KV-RESILIENCE.md](../architecture/KV-RESILIENCE.md)
...
> Full deep-dive → [KV-RESILIENCE.md](../architecture/KV-RESILIENCE.md)
