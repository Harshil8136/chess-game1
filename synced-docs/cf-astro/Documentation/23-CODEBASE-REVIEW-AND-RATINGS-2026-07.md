...
| Decision records                              | ADR-0001 (fail-open limits), ADR-0002 (no CAPTCHA on booking), ADR-0003 (audit-first dead-letter) in `docs/adr/` (moved to `Documentation/adr/` on 2026-09-15); `db/README.md` documents the two migration trees; `Documentation/ARCO-DSR-RUNBOOK.md` operationalizes the 20-day DSR window. |
